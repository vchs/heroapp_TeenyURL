...
export VCAP_SERVICES='{
    "redis-2.4": [{"name": "teenyurl-redis-cache-prod", "credentials": { "host": "localhost", "port": 6379 } }],
    "postgres-9.1": [{"name": "teenyurl-postgres-prod", "credentials": { "database": "teenyurl", "username": "progres"} }]
}'
